...
import type { FeaturedArtwork } from '@/lib/featured-artworks';
...
export default function HomeClient({
  ...
  /** null = server fetch failed (render fallback); [] = genuinely empty */
  featured: FeaturedArtwork[] | null;
}) {
  return (
    <div>
      <Hero />
...
function NewArrivals({ artworks }: { artworks: FeaturedArtwork[] }) {
...
function FoundersNote() {
  return (
    ...
    >
      <div style={{ maxWidth: '56ch', marginLeft: 'auto', marginRight: 'auto', textAlign: 'center' }}>
        <p
          style={{
            fontSize: '0.66rem',
            letterSpacing: '0.2em',
